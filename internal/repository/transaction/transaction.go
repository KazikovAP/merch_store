...
type Repository interface {
	Create(ctx context.Context, senderID, receiverID int, amount int) error
	GetByUserID(ctx context.Context, userID int) ([]domain.Transaction, error)
	GetBySenderID(ctx context.Context, senderID int) ([]domain.Transaction, error)
	GetByReceiverID(ctx context.Context, receiverID int) ([]domain.Transaction, error)
}
...
func (r *Repo) Create(ctx context.Context, senderID, receiverID, amount int) error {
...
func (r *Repo) queryTransactions(ctx context.Context, query string, args ...interface{}) ([]domain.Transaction, error) {
...
func (r *Repo) GetByUserID(ctx context.Context, userID int) ([]domain.Transaction, error) {
	const query = `
...
func (r *Repo) GetBySenderID(ctx context.Context, senderID int) ([]domain.Transaction, error) {
	const query = `
        SELECT t.id, t.sender_id, t.receiver_id, t.amount, t.created_at,
               s.username as sender_name, r.username as receiver_name
        FROM transactions t
...
func (r *Repo) GetByReceiverID(ctx context.Context, receiverID int) ([]domain.Transaction, error) {
	const query = `
        SELECT t.id, t.sender_id, t.receiver_id, t.amount, t.created_at,
               s.username as sender_name, r.username as receiver_name
        FROM transactions t
